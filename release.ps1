...
$changelog = git log $logRange --oneline --no-merges 2>$null
if (-not $changelog) { $changelog = "No changes." }
...
$releaseInfo | ConvertTo-Json -Depth 3 | Out-File -FilePath "release.json" -Encoding utf8NoBOM
