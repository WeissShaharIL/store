...
import { Trash, Upload, Image as ImageIcon, Eye, EyeOff } from "../../components/Icons.jsx";
import {
  adminGetTemplates,
  adminGetTemplate,
  adminCreateTemplate,
...
import BuilderToolbar from "./closet-builder/BuilderToolbar.jsx";
  ...
  return (
    <div className="closet-builder-section">
      <div className="closet-builder">
        <BuilderToolbar
          currentId={currentId} loadTemplate={loadTemplate} drafts={drafts} ready={ready}
          newOne={newOne} surpriseMe={surpriseMe} saveCurrent={saveCurrent}
          isReady={isReady} toggleReady={toggleReady}
          isDisplaySale={isDisplaySale} setIsDisplaySale={setIsDisplaySale}
          displaySalePrice={displaySalePrice} setDisplaySalePrice={setDisplaySalePrice}
          duplicateCurrent={duplicateCurrent} deleteCurrent={deleteCurrent}
          exportCurrent={exportCurrent} triggerImport={triggerImport} exportLibrary={exportLibrary}
          fileInputRef={fileInputRef} handleImportFile={handleImportFile} status={status}
        />
